...
installation (or create a symlink) or run:

script/plugin install git://github.com/kardasa/redminelocalavatars.git 
...
Andrzej Kardaś  Forked this source code to add polish translation and easyup redmine plugin installation for my admin (bzr is not as popular as git :D)
